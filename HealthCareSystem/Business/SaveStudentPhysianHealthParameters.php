...
$patientid = $_POST['pappointmentstudentid'];
...
$appointment = $ad->createAppointment($cgsHospital[0]->id,$doctor,$appInfo[0]->appointmentdate,"00:00 - 00:00",$patientid,'Y',$studentInfo[0]->name,"General");
    //print_r($appointment);
//$sql = "update school_appointment set generalappointment = '$appointment' where id = $appointmentid";
$sql = "INSERT INTO school_student_appointment_mapping
(schoolid, studentid, appointmentid, generalappointment, status, createddate, createdby) 
