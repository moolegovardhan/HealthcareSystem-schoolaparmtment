...
$pd = new PatientData();
        ...
        try{
            $patientuniqueid = $pd->generateNewUserSeqNumber('Industry','Industry',"users");
          ...
          $sql = "INSERT INTO users ( username, password, email, mobile, profession, address, name, middlename, lastname, firstname, dob, gender, city, state, zipcode, "
                  ...
                  . ":age,CURDATE(),'Web','Industry','$userid','$patientuniqueid','$officeid','$cardtype',DATE_ADD(CURDATE(), INTERVAL 730 DAY)  )";
          //echo $sql;
          ...
          $db = $dbConnection->getConnection(); 
           ...
           $finalAddress =  $address1." ".$address2;
            ...
            $schoolSql = "INSERT INTO industry_employee (emppatientid,employeeid, industryid, department, testgroup, status, createddate, createdby) 
                            VALUES ('$finalUser','$employeeid', '$officeid', '$departmentname', '$testgroup', 'Y', CURDATE(), $userid)";
...
$url = "http://".$_SESSION['host']."/".$_SESSION['rootNode']."/Web/industry/industryindex.php?page=employee";
