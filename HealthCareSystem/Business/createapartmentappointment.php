...
function createAppointment($apartmentid,$appointmentdate,$apartmentname){
   
     $dbConnection = new BusinessHSMDatabase();
     $userid = $_SESSION['userid'];
     try{
    $sql = "INSERT INTO apartment_appointment(apartmentid, appointmentdate, status, createddate, createdby, apartmentname) 
             VALUES ('$apartmentid', '$appointmentdate', 'Y', CURDATE(), '$userid', '$apartmentname')";
...
$url = "http://".$_SESSION['host']."/".$_SESSION['rootNode']."/Web/callcenter/callcenterindex.php?page=apartmenthealthcheckup";
