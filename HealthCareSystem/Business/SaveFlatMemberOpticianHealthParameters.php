...
$sql = "INSERT INTO apartment_optomology
(patientid, doctorid, appointmentid, complaints, observations, apartmentid, flatnumber, rDiagnosis, lDiagnosis, rDiagnosisCode, lDiagnosisCode, rLidsandAdnexae, lLidsandAdnexae,
...
VALUES ($patientid, $doctor, $appointmentid, '$complaints', '$observations', '$officeid', '$flatnumber', '$rDiagnosis', '$lDiagnosis', '$rDiagnosisCode', '$lDiagnosisCode', 
...
'$rPupil', '$lPupil', '$rLens', '$lLens', '$rOcularMovements', '$lOcularMovements', 'Y', $userid, CURDATE(), '$receiptid')";
