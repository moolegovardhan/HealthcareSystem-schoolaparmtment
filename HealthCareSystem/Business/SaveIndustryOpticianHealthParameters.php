...
$patientid = $_POST['oappointmentempid'];
...
$receiptid =  "HCM".$date."INDOPT".mt_rand(0, 999);
$status = 'Y';
$sql = "INSERT INTO industry_optomology
(patientid, doctorid, appointmentid, complaints, observations, industryid, rDiagnosis, lDiagnosis, rDiagnosisCode, lDiagnosisCode, rLidsandAdnexae, lLidsandAdnexae,
...
VALUES ($patientid, $doctor, $appointmentid, '$complaints', '$observations', '$officeid', '$rDiagnosis', '$lDiagnosis', '$rDiagnosisCode', '$lDiagnosisCode', 
