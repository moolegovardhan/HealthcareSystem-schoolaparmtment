...
try{
    $dbConnection = new BusinessHSMDatabase();
                $sql = "UPDATE village_appointment SET  appointmentdate = '$appdate',
...
$url = "http://".$_SESSION['host']."/".$_SESSION['rootNode']."/Web/callcenter/callcenterindex.php?page=editvillagestatus";
