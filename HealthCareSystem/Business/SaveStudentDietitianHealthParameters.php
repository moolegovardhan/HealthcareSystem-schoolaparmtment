...
$patientid = $_POST['dappointmentstudentid'];
...
$date = (date('ymdHis'));
   ...
   $receiptid =  "HCM".$date."SCHDIET".mt_rand(0, 999);

$dbConnection = new BusinessHSMDatabase();
$sql = "INSERT INTO school_dietitian
        (appointmentid, complaints, observations, mfrecomend, afrecomend, nfrecomend, schoolid, classid, studentid, status, dietitianid, createddate, createdby,receiptid) 
        VALUES ('$appointmentid', '$complaints', '$observations', '$mfrecomendation', '$afrecomendation', '$efrecomendation', '$officeid',
        '$classid', '$patientid', 'Y', '$dietitian', CURDATE(), '$userid','$receiptid')";
