...
function createAppointment($industryid,$appointmentdate,$industryname){
   
     $dbConnection = new BusinessHSMDatabase();
     $userid = $_SESSION['userid'];
     try{
    $sql = "INSERT INTO industry_appointment(industryid, appointmentdate, status, createddate, createdby, industryname) 
             VALUES ('$industryid', '$appointmentdate', 'Y', CURDATE(), '$userid', '$industryname')";
...
$url = "http://".$_SESSION['host']."/".$_SESSION['rootNode']."/Web/callcenter/callcenterindex.php?page=industryhealthcheckup";
