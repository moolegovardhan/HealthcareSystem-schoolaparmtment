...
$(document).ready(function(){
  ...
  $('#fetchApartmentAppointmentData').click( function(){
        
       //school_appointment__table
        console.log(rootURL + '/fetchApartmentAppointmentList/' + $('#schoollist').val());
        $.ajax({
            type: 'GET',
            url: rootURL + '/fetchApartmentAppointmentList/' + $('#schoollist').val(),
            dataType: "json",
            success: function(data){
    ...
    $('#district').change( function(){
      district = $('#district').val();
       console.log(rootURL + '/fetchApartmentList/' + district);
        $.ajax({
            type: 'GET',
            url: rootURL + '/fetchApartmentList/' + district,
            dataType: "json",
            success: function(data){
                 console.log('authentic : ' + data)
                var list = data == null ? [] : (data.responseMessageDetails  instanceof Array ? data.responseMessageDetails  : [data.responseMessageDetails ]); 
                    ...
                    $.each(list, function(index, responseMessageDetails) {
                         ...
                         if(responseMessageDetails.status == "Success"){
                                schoolData = responseMessageDetails.data;
                                 ...
                                 var trHTML = "";
                                strtext = '- Apartment -'
                                 $('<option>').val("APARTMENT").text(strtext).appendTo('#schoollist');
                                 $.each(schoolData, function(index, data) {
                                      $('<option>').val(data.id).text(data.apartmentname).appendTo('#schoollist');
                                 });
    ...
    $('#addApartmentAppointmentData').click( function(){
 ...
 <td>"+link+"</td></tr>";
    ...
    $('#showOpthoEntry').hide();
     ...
     $('#searchResultForHistory').show();
      $('#showstilltodoDetailsforFlat').hide();
    ...
    $('#searchIndustryEmployees').click(function(){
     ...
     $('#searchApartmentConsultationDetails').click( function(){
        ...
        console.log(rootURL+'/apartmentTotalHealthCheckup/'+$('#flatno').val());
        $.ajax({
                type: 'GET',
                contentType: 'application/json',
                url: rootURL+'/apartmentTotalHealthCheckup/'+$('#flatno').val(),
                dataType: "json",
                success: function(data, textStatus, jqXHR){
                   ...
                   var schoolData = responseMessageDetails.data;
                    ...
                    $.each(schoolData, function (index, data) {
                     ...
                     link = "<font color='blue'><a href='#' onclick=showClassDetails("+datatoPass+","+data.passdate+")>Fetch Details<a></font>";
                      trHTML = "<tr><td>"+data.flatnumber+"</td><td style='cursor: pointer' onclick=searchApartmentRemainingFlatmembers('+data.flatnumber+');>"+data.stilltodocount+"</td><td>"+data.count+"</td><td>"+data.appointmentdate+"</td><td>"+link+"</td></tr>";
                    //createVoucherHiddenTextBox(finaldata,count);
               ...
               $.each(list, function(index, responseMessageDetails) {
                   ...
                   var schoolData = responseMessageDetails.data;
                    ...
                    $.each(schoolData, function (index, data) {
                     ...
                     link = "<font color='blue'><a href='#' onclick=showOptoClassDetails("+datatoPass+","+data.passdate+")>Fetch Details<a></font>";
                      trHTML = "<tr><td>"+data.flat+"</td><td>"+data.count+"</td><td>"+data.appointmentdate+"</td><td>"+link+"</td></tr>";
                    //createVoucherHiddenTextBox(finaldata,count);
               ...
               $.each(list, function(index, responseMessageDetails) {
                   ...
                   var schoolData = responseMessageDetails.data;
                    ...
                    $.each(schoolData, function (index, data) {
                     ...
                     link = "<font color='blue'><a href='#' onclick=showDietClassDetails("+datatoPass+","+data.passdate+")>Fetch Details<a></font>";
                      trHTML = "<tr><td>"+data.flat+"</td><td>"+data.count+"</td><td>"+data.appointmentdate+"</td><td>"+link+"</td></tr>";
                    //createVoucherHiddenTextBox(finaldata,count);
...
function showDietClassDetails(classid,passdate){
 ...
 $('#showDetailsforClass').show();
    console.log(rootURL+'/fetchApartmentDietConsultationDetailsForClass/'+splitData[0]+'/'+splitData[1]);
        $.ajax({
                type: 'GET',
                contentType: 'application/json',
                url: rootURL+'/fetchApartmentDietConsultationDetailsForClass/'+splitData[0]+'/'+splitData[1],
                dataType: "json",
                success: function(data, textStatus, jqXHR){
               ...
               $.each(list, function(index, responseMessageDetails) {
                   ...
                   var schoolData = responseMessageDetails.data;
                    ...
                    $.each(schoolData, function (index, data) {
                      ...
                      trHTML = "<tr><td>"+data.memeberid+"</td><td>"+data.name+"</td><td>"+data.observations+"</td><td>"+data.complaints+"</td>\n\
...
function showOptoClassDetails(classid,passdate){
    ...
    $('#searchResultForHistory').hide();
 $('#showDetailsforClass').show();
    console.log(rootURL+'/fetchApartmentClassOptoHistory/'+splitData[0]+'/'+splitData[1]);
        $.ajax({
                type: 'GET',
                contentType: 'application/json',
                url: rootURL+'/fetchApartmentClassOptoHistory/'+splitData[0]+'/'+splitData[1],
                dataType: "json",
                success: function(data, textStatus, jqXHR){
...
<td>"+data.colo5+"</td></tr>";
 ...
 function searchApartmentRemainingFlatmembers(flatnumber){
    ...
    $('#searchResultForHistory').hide();
 $('#showstilltodoDetailsforFlat').show();
    console.log(rootURL+'/fetchApartmentStillCountMembers/'+$('#flatnumber').val());
        $.ajax({
                type: 'GET',
                contentType: 'application/json',
                url: rootURL+'/fetchApartmentStillCountMembers/'+$('#flatnumber').val(),
                dataType: "json",
                success: function(data, textStatus, jqXHR){
              ...
              var list = data == null ? [] : (data.responseMessageDetails instanceof Array ? data.responseMessageDetails : [data.responseMessageDetails]);
                ...
                console.log((list).length);
                 $('#apartment_flatmember_still_to_do_details_table tbody').remove();
               ...
               $.each(list, function(index, responseMessageDetails) {
                   ...
                   var schoolData = responseMessageDetails.data;
                    ...
                    $.each(schoolData, function (index, data) {
                      ...
                      trHTML = "<tr><td>"+data.apartmentid+"</td><td>"+data.flatnumber+"</td><td>"+data.name+"</td><td>"+data.mobile+"</td></tr>";
                    //createVoucherHiddenTextBox(finaldata,count);
                        
                         $('#apartment_flatmember_still_to_do_details_table').append(trHTML);
                        $('#apartment_flatmember_still_to_do_details_table').load();
...
function updateData(rowid){
    console.log(rowid);
     ...
     console.log(rootURL + '/fetchSpecificApartmentAppointmentList/' + rowid);
        $.ajax({
            type: 'GET',
            url: rootURL + '/fetchSpecificApartmentAppointmentList/' + rowid,
            dataType: "json",
            success: function(data){
