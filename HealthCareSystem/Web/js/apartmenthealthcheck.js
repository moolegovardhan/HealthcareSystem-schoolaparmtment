...
$(document).ready(function(){
    ...
    $('#searchflatmembers').click(function(){
        
        console.log($('#patientname').val());
        console.log($('#patientid').val());
        console.log($('#floornumber').val());
        console.log($('#flatnumber').val());
        ...
        console.log(rootURL+'/fetchFlatMembers/'+membername+'/'+memberid+'/'+flatnumber+'/'+block);
        $.ajax({
                type: 'GET',
                contentType: 'application/json',
                url: rootURL+'/fetchFlatMembers/'+membername+'/'+memberid+'/'+flatnumber+'/'+block,
                dataType: "json",
                success: function(data, textStatus, jqXHR){
                     
                    console.log(data);
                    
              $('#flat_member_search_table tbody').remove();      
               ...
               $.each(list, function(index, responseMessageDetails) {
                   ...
                   var apartmentData = responseMessageDetails.data;
                    ...
                    $.each(apartmentData, function (index, data) {
                     ...
                     datToPass = "'"+escape(data.flatnumber)+"'";
                            
                     general = "<font color='blue'><a href='#' onclick=enterDetails("+data.ID+","+data.flat+")>General<a></font>";
                      dietitian = "<font color='blue'><a href='#' onclick=enterDietitianDetails("+data.ID+","+data.flat+")>Dietitian<a></font>";
                       ophthalmology = "<font color='blue'><a href='#' onclick=enterOphthalmologyDetails("+data.ID+","+data.flat+")>Ophthalmology<a></font>";
                        physician  = "<font color='blue'><a href='#' onclick=enterPhysicianDetails("+data.ID+","+data.flat+")>Physician <a></font>";
                      trHTML = "<tr id="+count+"><td>"+data.flatnumber+"</td><td>"+data.block+"</td><td>"+data.name+"</td><td>"+data.ID+"</td>\n\
                   <td>"+data.mobile+"</td><td>"+general+"&nbsp;&nbsp;|&nbsp;&nbsp;"+dietitian+"&nbsp;&nbsp;|&nbsp;&nbsp; "+ophthalmology+" &nbsp;&nbsp;|&nbsp;&nbsp;"+physician+"</td></tr>";
                    //createVoucherHiddenTextBox(finaldata,count);
                     //   console.log(trHTML)
                         $('#flat_member_search_table').append(trHTML);
                        $('#flat_member_search_table').load();
    ...
    $('#searchApartmentConsultationDetails').click( function(){
        
         
        console.log(rootURL+'/fetchApartmentAppointmentHistory/'+$('#flatnumber').val());
        $.ajax({
                type: 'GET',
                contentType: 'application/json',
                url: rootURL+'/fetchApartmentAppointmentHistory/'+$('#flatnumber').val(),
                dataType: "json",
                success: function(data, textStatus, jqXHR){
              ...
              var list = data == null ? [] : (data.responseMessageDetails instanceof Array ? data.responseMessageDetails : [data.responseMessageDetails]);
                ...
                console.log((list).length);
                 $('#apartment_health_checkup_history_table tbody').remove();
               ...
               $.each(list, function(index, responseMessageDetails) {
                   ...
                   var apartmentData = responseMessageDetails.data;
                    ...
                    $.each(apartmentData, function (index, data) {
                     ...
                     datatoPass = "'"+escape(data.flatnumber+"#"+data.appointmentid)+"'";
                            console.log(datatoPass);
                     link = "<font color='blue'><a href='#' onclick=showClassDetails("+datatoPass+","+data.passdate+")>Enter Details<a></font>";
                      trHTML = "<tr><td>"+data.flatnumber+"</td><td>"+data.count+"</td><td>"+data.appointmentdate+"</td><td>"+link+"</td></tr>";
                    //createVoucherHiddenTextBox(finaldata,count);
                        console.log(trHTML);
                         $('#apartment_health_checkup_history_table').append(trHTML);
                        $('#apartment_health_checkup_history_table').load();
        ...
        $('#searchApartmentOptoConsultationDetails').click( function(){
        ...
        $.ajax({
              ...
              var list = data == null ? [] : (data.responseMessageDetails instanceof Array ? data.responseMessageDetails : [data.responseMessageDetails]);
                ...
                console.log((list).length);
                 $('#apartment_health_optocheckup_history_table tbody').remove();
               ...
               $.each(list, function(index, responseMessageDetails) {
                   ...
                   var apartmentData = responseMessageDetails.data;
                    ...
                    //createVoucherHiddenTextBox(finaldata,count);
                         ...
                         $('#apartment_health_optocheckup_history_table').append(trHTML);
                        $('#apartment_health_optocheckup_history_table').load();
    ...
    $('#searchApartmentDietConsultationDetails').click( function(){
        ...
        $.ajax({
              ...
              var list = data == null ? [] : (data.responseMessageDetails instanceof Array ? data.responseMessageDetails : [data.responseMessageDetails]);
                ...
                console.log((list).length);
                 $('#apartment_health_dietcheckup_history_table tbody').remove();
               ...
               $.each(list, function(index, responseMessageDetails) {
                   ...
                   var apartmentData = responseMessageDetails.data;
                    ...
                    //createVoucherHiddenTextBox(finaldata,count);
                         ...
                         $('#apartment_health_dietcheckup_history_table').append(trHTML);
                        $('#apartment_health_dietcheckup_history_table').load();
...
function showFlatDetails(flatnumber,passdate){
    console.log(unescape(flatnumber));
    console.log(passdate);//
    
    splitData = unescape(flatnumber).split("#");
    $('#searchResultForHistory').hide();
 $('#showDetailsforClass').show();
    console.log(rootURL+'/fetchApartmentConsultationDetailsForFlat/'+splitData[0]+'/'+splitData[1]);
        $.ajax({
                type: 'GET',
                contentType: 'application/json',
                url: rootURL+'/fetchApartmentConsultationDetailsForFlat/'+splitData[0]+'/'+splitData[1],
                dataType: "json",
                success: function(data, textStatus, jqXHR){
              ...
              var list = data == null ? [] : (data.responseMessageDetails instanceof Array ? data.responseMessageDetails : [data.responseMessageDetails]);
                ...
                console.log((list).length);
                 $('#apartment_health_checkup_history_details_table tbody').remove();
...
<td>"+data.colo5+"</td></tr>";
                    //createVoucherHiddenTextBox(finaldata,count);
                         ...
                         $('#apartment_health_checkup_history_details_table').append(trHTML);
                        $('#apartment_health_checkup_history_details_table').load();
...
function showOptoClassDetails(flatnumber,passdate){
    console.log(unescape(flatnumber));
    console.log(passdate);//
    ...
    $('#searchResultForHistory').hide();
 $('#showDetailsforClass').show();
    console.log(rootURL+'/fetchApartmentOptoConsultationDetailsForFlat/'+splitData[0]+'/'+splitData[1]);
        $.ajax({
                type: 'GET',
                contentType: 'application/json',
                url: rootURL+'/fetchApartmentOptoConsultationDetailsForFlat/'+splitData[0]+'/'+splitData[1],
                dataType: "json",
                success: function(data, textStatus, jqXHR){
              ...
              var list = data == null ? [] : (data.responseMessageDetails instanceof Array ? data.responseMessageDetails : [data.responseMessageDetails]);
                ...
                console.log((list).length);
                 $('#apartment_health_checkup_history_opto_details_table tbody').remove();
               ...
               $.each(list, function(index, responseMessageDetails) {
                   ...
                   var apartmentData = responseMessageDetails.data;
                    ...
                    //createVoucherHiddenTextBox(finaldata,count);
                         ...
                         $('#apartment_health_checkup_history_opto_details_table').append(trHTML);
                        $('#apartment_health_checkup_history_opto_details_table').load();
...
function showDietClassDetails(flatnumber,passdate){
    console.log(unescape(flatnumber));
    console.log(passdate);//
    ...
    $('#searchResultForHistory').hide();
 $('#showDetailsforClass').show();
    console.log(rootURL+'/fetchApartmentDietConsultationDetailsForFlat/'+splitData[0]+'/'+splitData[1]);
        $.ajax({
                type: 'GET',
                contentType: 'application/json',
                url: rootURL+'/fetchApartmentDietConsultationDetailsForFlat/'+splitData[0]+'/'+splitData[1],
                dataType: "json",
                success: function(data, textStatus, jqXHR){
              ...
              var list = data == null ? [] : (data.responseMessageDetails instanceof Array ? data.responseMessageDetails : [data.responseMessageDetails]);
                ...
                console.log((list).length);
                 $('#apartment_health_checkup_history_diet_details_table tbody').remove();
...
<td>"+data.nfrecomend+"</td></tr>";
                    //createVoucherHiddenTextBox(finaldata,count);
                         ...
                         $('#apartment_health_checkup_history_diet_details_table').append(trHTML);
                        $('#apartment_health_checkup_history_diet_details_table').load();
...
function enterDetails(memberid,flatnumber){
  //  flatnumber = unescape(flatnumber);
    console.log(memberid); console.log(flatnumber);
    $('#appointmentflatmemberid').val(memberid);
     $('#gflatnumber').val(flatnumber);
      $('#showSearch').hide();
    $('#showDataEntry').show();
     $('#showPhysianEntry').hide();
}

function enterDietitianDetails(memberid,flatnumber){
   // flatnumber = unescape(flatnumber);
   // console.log(memberid);
    $('#dappointmentflatmemberid').val(memberid);
     $('#dflatnumber').val(flatnumber);
      $('#showSearch').hide();
    $('#showDataEntry').hide();
...
function enterOphthalmologyDetails(memberid,flatnumber){
    $('#oappointmentstudentid').val(memberid);
     $('#oflatnumber').val(flatnumber);
      $('#showSearch').hide();
    $('#showDataEntry').hide();
    $('#showDietitianEntry').hide();
    $('#showOpthoEntry').show();
...
function enterPhysicianDetails(memberid,flatnumber){
    $('#pappointmentflatmemberid').val(memberid);
     $('#pflatnumber').val(flatnumber);
      $('#showSearch').hide();
    $('#showDataEntry').hide();
    $('#showDietitianEntry').hide();
    $('#showOpthoEntry').hide();
