...
function fetchDetails(){
    ...
    if(validateSearchForm()){
      ...
      console.log(rootURL + '/fetchCallcenterPrescription/' + patientname +'/'+patientid +'/'+appid+'/'+mobile);  
            $.ajax({
                type: 'GET',
                url: rootURL +  '/fetchCallcenterPrescription/' + patientname +'/'+patientid +'/'+appid+'/'+mobile,
                dataType: "json",
