...
$result = $dd->getMedicalRechargeDetails($_SESSION['officeid'],$startDate,$endDate,'Lab');
...
function showDiscountData(){
    ...
    start = $('#start').val();
    finish = $('#finish').val();
    window.location.href = "labindex.php?page=cardrecharge&start="+start+"&finish="+finish;
}
</script>
