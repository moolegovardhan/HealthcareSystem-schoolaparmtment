...
<body class="boxed-layout container">
   ...
   <div class="wrapper">
      ...
      <div class="header">
        <!-- Topbar -->
        <div class="topbar">
          <?php  include_once('schoolheader.php'); ?>
        </div>
        <!-- End Topbar -->
      </div>
      <!-- End Header -->
            ...
            <div class="row">  
                <div >
                    <?php if(($_GET['page']) == "profile") { ?>
                        <?php  include_once('schoolprofile.php');  ?>
                    <?php } else if(($_GET['page']) == "details") { ?>
                        <?php  include_once('schooldetails.php');  ?>
                    <?php } else  if(($_GET['page']) == "students") { ?>
                        <?php  include_once('schoolstudents.php');  ?>
                    <?php } else   if(($_GET['page']) == "teacher") { ?>
                        <?php  include_once('schoolteacher.php');  ?>
                    ...
                    <?php } else   if($_GET['page'] == "ordermedicines") { ?>
                        ...
                        <?php } else {?>
                        <?php  include_once('schoolhome.php');  ?>
                    <?php } ?>
                </div>
             </div>    
           </div>    
 ...
 <script src="../js/schoolmain.js"></script>
