...
<div class="col-md-12 sky-form" >
    ...
    <fieldset>
     ...
     <section class="col-md-2">
         ...
         <button type="button" class="btn-u"  name="button" id="searchSchoolStudents" > Search </button>
        </section>
    </fieldset>
    <fieldset>
        <section class="col-md-12">
            <table class="table table-striped" id="school_student_search_table">
                <thead>
    ...
    <div id="showDataEntry">
        ...
        <form class=" sky-form" action="../../Business/SaveStudentHealthParameters.php" method="POST">
                <input type="hidden" name="appointmentstudentid" id="appointmentstudentid" />
    ...
    <div id="showDietitianEntry">
        ...
        <form  action="../../Business/SaveStudentDietitianHealthParameters.php" method="POST">
                <input type="hidden" name="dappointmentstudentid" id="dappointmentstudentid" />
    ...
    <div id="showOpthoEntry">
        ...
        <form  action="../../Business/SaveStudentOpticianHealthParameters.php" method="POST">
       ...
       <div id="showPhysianEntry">
        ...
        ?>
                <form  action="../../Business/SaveStudentPhysianHealthParameters.php" method="POST">
                        <input type="hidden" name="pappointmentstudentid" id="pappointmentstudentid" />
