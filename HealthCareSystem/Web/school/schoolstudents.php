...
<div class="col-md-12"> 
    ...
    <?php } ?>
  <form id="registerform"  action="../../Business/StudentPhotoUpload.php" method="POST" class="sky-form"  enctype="multipart/form-data">   
 <fieldset>
    <div class="col-md-14">
        <div class="row">
...
<div class="panel panel-orange margin-bottom-40">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-user"></i>Student Registration</h3>
                    </div>
           ...
           <input type="hidden" id="host" value="<?php   print( $_SERVER['HTTP_HOST']);     ?>" />  
            ...
            <!-- Section 1 end -->
               <fieldset >  
                ...
                <section class="col-md-2">
                  <label class="input">
                      <input type="text" id="rollno"  name="rollno" placeholder="Roll #" size="4" />
                    </label>
        ...
        <fieldset>
          ...
          <!-- end of section 4 -->
            ...
            <div class="modal-footer">
                ...
                <input type="submit" value="Register Student" class="btn-u btn-u-primary" id="registerStudentk"/>
