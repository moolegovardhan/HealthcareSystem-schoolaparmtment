...
<div class="col-md-12 sky-form" >
    ...
    <fieldset>
        ...
        <section class="col-md-3">
         ...
         <section class="col-md-2">
          <label class="input">
              <input type="text" id="streetname"  name="streetname" placeholder="Street Name" size="4" />    
            </label>
     ...
     <section class="col-md-2">
         ...
         <button type="button" class="btn-u"  name="button" id="searchhousemembers" > Search </button>
        </section>
    </fieldset>
    <fieldset>
        <section class="col-md-12">
            <table class="table table-striped" id="house_member_search_table">
                <thead>
    ...
    <div id="showDataEntry">
        ...
        <form class=" sky-form" action="../../Business/SaveHouseMemberHealthParameters.php" method="POST">
                <input type="hidden" name="appointmenthousememberid" id="appointmenthousememberid" />
                <input type="hidden" name="ghousenumber" id="ghousenumber" />
                <fieldset>
                    <section class="col-md-4">
                        <label class="select">
                            <select id="appointmentdate" name="appointmentdate" >
                                  ...
                                  <?php
                                   if(sizeof($villageAppointment) > 0) {
                                       foreach($villageAppointment as $appointment){
                                  ?>
                    ...
                    <section id="doctoriddiv" class="col col-4">
                        <label class="input">
                           <i class="icon-append fa fa-asterisk"></i>
                           <input type="text" id="cholo1" name="cholo1"  placeholder="Weight" class="valid" >
                   ...
                   <section id="doctoriddiv" class="col col-4">
                            <label class="input">
                               <i class="icon-append fa fa-asterisk"></i>
                               <input type="text" id="cholo2" name="cholo2"  placeholder="Height" class="valid" >
    ...
    <div id="showDietitianEntry">
        ...
        <form  action="../../Business/SaveHouseMemberDietitianHealthParameters.php" method="POST">
                <input type="hidden" name="dappointmenthousememberid" id="dappointmenthousememberid" />
                <input type="hidden" name="dhousenumber" id="dhousenumber" />
                <section class="col-md-12">
                    <br/><br/><br/><br/>
                    ...
                    <section class="col-md-4">
                        <label class="select">
                            <select id="dietappointmentdate" name="dietappointmentdate" >
                                  <option value="nodata">- Appointment Date -</option>
                                  <?php
                                   if(sizeof($villageAppointment) > 0) {
                                       foreach($villageAppointment as $appointment){
    ...
    <div id="showOpthoEntry">
        ...
        <form  action="../../Business/SaveHouseMemberOpticianHealthParameters.php" method="POST">
                <input type="hidden" name="oappointmenthouseid" id="oappointmenthouseid" />
                <input type="hidden" name="ohousenumber" id="ohousenumber" />
                
                <!-- Optomology start -->
                <section class="col-md-12"><br/><br/></section>
                <section class="col-md-3">
                        <label class="select">
                            <select id="oappointmentdate" name="oappointmentdate" >
                                  <option value="nodata">- Appointment Date -</option>
                                  <?php
                                   if(sizeof($villageAppointment) > 0) {
                                       foreach($villageAppointment as $appointment){
       ...
       <div id="showPhysianEntry">
        ...
        ?>
                <form  action="../../Business/SaveHouseMemberPhysianHealthParameters.php" method="POST">
                        <input type="hidden" name="pappointmenthousememberid" id="pappointmenthousememberid" />
                        <input type="hidden" name="phousenumber" id="phousenumber" />
                   ...
                   <section class="col-md-12"><br/>
                       ...
                       <br/></section>
                        <section class="col-md-3">
                                <label class="select">
                                    <select id="phyappointmentdate" name="phyappointmentdate" >
                                          <option value="nodata">- Appointment Date -</option>
                                          <?php
                                           if(sizeof($villageAppointment) > 0) {
                                               foreach($villageAppointment as $appointment){
                             ...
                             <div class="row">
                               ...
                               <div class="row">
                                ...
                                <div id="medicinestabledata">
                                    <input type="hidden"  name="villcounter" id="villcounter" />
                               </div>
