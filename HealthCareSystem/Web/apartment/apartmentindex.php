...
<body class="boxed-layout container">
   ...
   <div class="wrapper">
      ...
      <div class="header">
        <!-- Topbar -->
        <div class="topbar">
          <?php  include_once('apartmentheader.php'); ?>
        </div>
        <!-- End Topbar -->
      </div>
      <!-- End Header -->
      ...
      <input type="hidden" id="rootnode" value="<?php print_r($_SESSION['rootNode']);?>" />
       ...
       <div class="container">
        <div class="col-md-14">
            <div class="row">  
                <div >
                    <?php if(($_GET['page']) == "apartmentprofile") { ?>
                        <?php  include_once('apartmentprofile.php');  ?>
                    <?php } else if(($_GET['page']) == "apartmentdetails") { ?>
                        <?php  include_once('apartmentdetails.php');  ?>
                    <?php } else  if(($_GET['page']) == "registermember") { ?>
                        <?php  include_once('apartmentmembers.php');  ?>
                    ...
                    <?php } else   if($_GET['page'] == "ordermedicines") { ?>
                        ...
                        <?php } else   if($_GET['page'] == "employee") { ?>
                        <?php  include_once('industryemployee.php');  ?>
                        ...
                        <?php } else {?>
                        <?php  include_once('apartmenthome.php');  ?>
                    <?php } ?>
                </div>
             </div>    
           </div>    
