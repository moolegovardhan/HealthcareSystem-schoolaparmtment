...
<?php 
 ...
 $ad = new AppointmentData();
     ...
     $start = $_GET['start'];
     $end = $_GET['end'];
 $appointmentData = ($ad->fetchAdminRechargeData($start, $end));
...
function showAppointmentData(){
    ...
    window.location.href = "adminindex.php?page=rechargereport&start="+start+"&end="+end;
}
</script> 
    <fieldset>
    <div class="row">
      ...
      <section class="col-md-3">
       ...
       <font color="red"><i><span id="userIderr"></span></i></font>    
        ...
        <section class="col-md-6">
         <div class="btn-group">
             <button type="button" class="btn-u btn-u-blue" onclick="showAppointmentData()">
                         ...
                         $appointmentSum = 0;
                          $actualSum = 0;
                               foreach($appointmentData as $result){
                                   $onclick = "";
                                   if($result->insttype == "Medical Shop")
                                           $goto = "Medical";
                                   else if($result->insttype == "Lab")
                                           $goto = "Lab";
                                   else if($result->insttype == "Hospital")
                                           $goto = "Hospital";
                                   else 
                                       $goto = "-";
                                   if( $goto != "-"){
                                       $onclick = "onclick = calldrilldown('$goto')";
                                   }
                          ...
                          <tr <?php echo $onclick; ?>>
                                   ...
                                   <td><?php  echo $result->insttype; ?></td>
