...
<script src="../js/cardlabdiscount.js"></script> 
<div class="sky-form">
    <style>
        .ui-datepicker{ z-index: 9999 !important;}
        </style>
     <form  method="post" action="../../Business/cardlabdiscountdetails.php">
        <fieldset>
...
<div class="row">
  ...
  <section class="col col-md-3" >
    ...
    <section class="col-md-4">
     <div class="btn-group">
         <button type="button" class="btn-u btn-u-blue" id="addCardLabDetails">
     ...
     <div class="btn-group">
        ...
        <div>
            <fieldset>
                ...
                <table class="table table-striped" id="card_lab_details_table">
                    <thead>
