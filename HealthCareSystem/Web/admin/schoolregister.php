<div class="sky-form col-md-12">
    ...
    <fieldset>
        <div class="col-md-12 row">
            ...
            <form  method="POST" action="../../Business/RegisterSchool.php" >
                  ...
                  <section class="col-md-4 input-group margin-bottom-20">
                      ...
                      <input type="text" id="schoolname"  name="schoolname"  placeholder="School Name" class="form-control  state-success">
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-4">
                          ...
                          <input type="submit" value="Register School" id="login" class="btn-u" />
                      </div>
                  </div>
