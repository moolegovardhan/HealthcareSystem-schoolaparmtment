<div class="sky-form col-md-12">
    ...
    <fieldset>
        <div class="col-md-12 row">
            ...
            <form  method="POST" action="../../Business/RegisterVillage.php" >

                  <div class="reg-header">            
                      <h2>Register Village</h2>
                  </div>

                  <section class="col-md-4 input-group margin-bottom-20">
                      <span class="input-group-addon"><i class="fa fa-user"></i></span>
                      <input type="text" id="villagename"  name="villagename"  placeholder="Village Name" class="form-control  state-success">
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-4">
                          ...
                          <input type="submit" value="Register Village" id="login" class="btn-u" />
                      </div>
                  </div>
