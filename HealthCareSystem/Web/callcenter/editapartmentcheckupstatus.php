...
<div class="col-md-12 sky-form" >
    ...
    <fieldset>
        ...
        <section class="col col-md-4">
         ...
         <button type="button" class="btn-u"  name="button" id="fetchApartmentAppointmentData" > Fetch Data </button>
        </section>
    ...
    <form action="../../Business/SaveUpdateApartmentAppointment.php" method="POST">
