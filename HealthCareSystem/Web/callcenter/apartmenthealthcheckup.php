...
?>
<form method="post" action="../../Business/createapartmentappointment.php">
...
<div class="col-md-12 sky-form" >
    ...
    <fieldset>
        ...
        <section class="col col-md-4">
         ...
         <button type="button" class="btn-u"  name="button" id="addApartmentAppointmentData" > Add Data </button>
        </section>
