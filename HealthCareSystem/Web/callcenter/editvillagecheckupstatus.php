...
<div class="col-md-12 sky-form" >
    ...
    <fieldset>
        ...
        <section class="col col-md-4">
         ...
         <button type="button" class="btn-u"  name="button" id="fetchVillageAppointmentData" > Fetch Data </button>
        </section>
        
    </fieldset>
    <fieldset>
        <section class="col-md-12">
        <table class="table table-striped" id="village_appointment_table">
            <thead>
    ...
    <form action="../../Business/SaveUpdateVillageAppointment.php" method="POST">
