...
<script src="../js/villagehealthcheckup.js"></script> 
<?php
include_once '../../Business/VillageData.php';


?>
<form method="post" action="../../Business/createvillageappointment.php">
...
<div class="col-md-12 sky-form" >
    ...
    <fieldset>
        ...
        <section class="col col-md-4">
                   ...
                   <section class="col col-4">
                            <label class="select">
                            <select id="villagelist" class="form-control" >
         ...
         <button type="button" class="btn-u"  name="button" id="addVillageAppointmentData" > Add Data </button>
        </section>
        <section class="col-md-3">
               <button type="submit" class="btn-u"  name="submit" id="createVillageDetails" > Create Appointments </button>
       
        </section>
    </fieldset>
    <fieldset>
        <section class="col-md-12">
        <table class="table table-striped" id="village_appointment_details_table">
            <thead>
