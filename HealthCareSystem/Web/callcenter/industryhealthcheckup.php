...
?>
<form method="post" action="../../Business/createindustryappointment.php">
    ...
    <fieldset>
        ...
        <section class="col col-md-4">
                          <label class="select">
                            ...
                            <option value="Chhattisgarh">Chatisgarh</option>
         ...
         <button type="button" class="btn-u"  name="button" id="addIndustryAppointmentData" > Add Data </button>
        </section>
