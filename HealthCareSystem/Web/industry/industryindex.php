...
<body class="boxed-layout container">
   ...
   <div class="wrapper">
      ...
      <div class="header">
        <!-- Topbar -->
        <div class="topbar">
          <?php  include_once('industryheader.php'); ?>
        </div>
        <!-- End Topbar -->
      </div>
      <!-- End Header -->
            ...
            <div class="row">  
                <div >
                    <?php if(($_GET['page']) == "profile") { ?>
                        <?php  include_once('industryprofile.php');  ?>
                    <?php } else if(($_GET['page']) == "department") { ?>
                        <?php  include_once('industrydepartment.php');  ?>
                    <?php } else  if(($_GET['page']) == "testgroup") { ?>
                        <?php  include_once('testgroup.php');  ?>
                    ...
                    <?php } else   if($_GET['page'] == "ordermedicines") { ?>
                        ...
                        <?php } else {?>
                        <?php  include_once('industryhome.php');  ?>
                    <?php } ?>
                </div>
             </div>    
           </div>    
