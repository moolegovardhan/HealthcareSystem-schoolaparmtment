...
<div class="col-md-12"> 
    ...
    <?php } ?>
  <form id="registerform"  action="../../Business/IndustryPhotoUpload.php" method="POST" class="sky-form"  enctype="multipart/form-data">   
 <fieldset>
    <div class="col-md-14">
        <div class="row">
...
<div class="panel panel-orange margin-bottom-40">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-user"></i>Employee Registration</h3>
                    </div>
            ...
            <!-- Section 1 end -->
               <fieldset >  
                ...
                <section class="col-md-2">
                    <label class="select">
                        <select id="testgroup" name="testgroup" name="testgroup" >
                              <option value="nodata">- Test Group -</option>
                        <?php  
                ...
                <section class="col-md-2">
                  <label class="input">
                      <input type="text" id="employeeid"  name="employeeid" placeholder="Employee Id #" size="4" />
                    </label>
        ...
        <fieldset>
                      ...
                      <section class="col-md-4">
                           ...
                           <select id="cardtype" name="cardtype" >
                                 <option value="cardtype">- Select Card Type -</option>
                                       ...
                                       <option value="IND-800">IND-800</option>
                                       <option value="IND-1600">IND-1600</option>
                                       <option value="IND-2400">IND-2400</option>
          ...
          <!-- end of section 4 -->
            ...
            <div class="modal-footer">
                ...
                <input type="submit" value="Register Employee" class="btn-u btn-u-primary" id="registerStudentk"/>
