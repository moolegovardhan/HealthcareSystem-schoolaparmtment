...
if( isset( $_SESSION['userid'] ) )
   {
      ...
      $labDataDetails = $dd->getIndustryUnMapTestData($officeid);
...
<div class="col-md-12">  
    <fieldset>
        ...
        <section class="col col-md-9">
                ...
                <button data-dismiss="modal" class="btn-u btn-u-orange pull-right" type="button" onclick="linkTestLab()" >Link to Industry</button>
