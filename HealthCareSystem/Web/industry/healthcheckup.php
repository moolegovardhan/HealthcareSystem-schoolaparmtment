<?php session_start(); 
 ...
 $department =  $id->fetchIndustryDepartmentDetails($_SESSION['officeid']);
   $testgroup = $id->fetchIndustryGroupDetails($_SESSION['officeid']);
$schoolAppointment = $id->fetchIndustryAppointmentList($_SESSION['officeid']);
...
<div class="col-md-12 sky-form" >
    ...
    <fieldset>
     ...
     <section class="col-md-2">
         ...
         <button type="button" class="btn-u"  name="button" id="searchIndustryEmployees" > Search </button>
        </section>
    </fieldset>
    <fieldset>
        <section class="col-md-12">
            <table class="table table-striped" id="industry_employee_search_table">
                <thead>
    ...
    <div id="showDataEntry">
        ...
        <form class=" sky-form" action="../../Business/SaveIndustryHealthParameters.php" method="POST">
                <input type="hidden" name="appointmentempid" id="appointmentempid" />
                    ...
                    <section class="col-md-4">
                        <label class="select">
                            <select id="appointmentid" name="appointmentid" >
                                  ...
                                  <?php
                                   if(sizeof($schoolAppointment) > 0) {
                                       foreach($schoolAppointment as $appointment){
                                  ?>
    ...
    <div id="showDietitianEntry">
        ...
        <form  action="../../Business/SaveIndustryDietitianHealthParameters.php" method="POST">
                <input type="hidden" name="dappointmentempid" id="dappointmentempid" />
                <input type="hidden" name="dclassid" id="dclassid" />
                <section class="col-md-12">
                    <br/><br/><br/><br/>
                ...
                <section class="col-md-4">
                    ...
                    <section id="doctoriddiv" class="col col-4">
                            <label class="input">
                                <textarea id="observation"  name="observation" placeholder="Observations" rows="3" cols="30"></textarea>
    ...
    <div id="showOpthoEntry">
        ...
        <form  action="../../Business/SaveIndustryOpticianHealthParameters.php" method="POST">
                <input type="hidden" name="oappointmentempid" id="oappointmentempid" />
                <input type="hidden" name="oclassid" id="oclassid" />
       ...
       <div id="showPhysianEntry">
        ...
        ?>
                <form  action="../../Business/SaveIndustryPhysianHealthParameters.php" method="POST">
                        <input type="hidden" name="pappointmentempid" id="pappointmentempid" />
