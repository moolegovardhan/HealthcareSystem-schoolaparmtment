...
function showMedPatientSearch(){
    patientname = $('#patientname').val();
   
    start = $('#start').val();
    end = $('#end').val();
    window.location.href = "medicalindex.php?page=payments&patientname="+patientname+"&start="+start+"&end="+end;
...
function nextSetOfRecords(){
    ...
    window.location.href = "medicalindex.php?page=payments&start="+start+"&end="+end;
   ...
   <form action="#" id="sky-form"  method="POST" >  
            ...
            <div class="row sky-form ">
               ...
               <input type="hidden" name="patientname" id="patientname"  value="<?php echo $_GET['patientname']; ?>"/>
                <section class="col-md-3">
                    <input type="button" class="btn-u pull-right"  name="button" id="searchPatientName" value="Search" onclick="showMedPatientSearch()"/>
                </section>
               <section class="col-md-3">
       ...
       <section class="col col-md-10">
             <table class="table table-striped" id="patient_medicines_order_patient_table">
                ...
                <tbody>
                    ...
                    if(count($patientData) > 0){ foreach($patientData as $data){ ?>
                    <tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                     <button data-dismiss="modal" class="btn-u btn-u-orange" type="button" id="submitMedicalPatientPaymentDetails">Submit</button>
